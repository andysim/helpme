...
TEST_CASE("check that updates of kappa and unit cell parameters give the correct behavior.") {
    ...
    helpme::Matrix<double> refForces4({{-0.76682663, -0.94766815, 7.42058381},
                                       {0.61559595, 0.53986198, -2.96384799},
                                       {0.42875295, 0.68212956, -3.03458962},
                                       {-1.40348529, -1.29177218, 5.92864929},
                                       {0.52356758, 0.58714559, -3.77867550},
                                       {0.60096417, 0.43005199, -3.57252549}});
    ...
    helpme::Matrix<double> refForces5({{-0.84350929, -1.04243496, 8.16264219},
                                       {0.67715554, 0.59384818, -3.26023278},
                                       {0.47162825, 0.75034251, -3.33804858},
                                       {-1.54383381, -1.42094940, 6.52151422},
                                       {0.57592433, 0.64586015, -4.15654305},
                                       {0.66106059, 0.47305718, -3.92977804}});
    ...
    helpme::Matrix<double> refForces6({{-0.84303319, -1.04235328, 8.16169899},
                                       {0.67691837, 0.59393522, -3.25971866},
                                       {0.47193007, 0.75038734, -3.33749220},
                                       {-1.54317624, -1.42071063, 6.52017613},
                                       {0.57607320, 0.64578806, -4.15560408},
                                       {0.66144590, 0.47300418, -3.92883941}});
    ...
    helpme::Matrix<double> refForces7({{-0.00111343, -0.00137705, 0.00829002},
                                       {0.00081670, 0.00071313, -0.00320443},
                                       {0.00059187, 0.00095086, -0.00324183},
                                       {-0.00187292, -0.00173646, 0.00637289},
                                       {0.00076641, 0.00086005, -0.00423731},
                                       {0.00081164, 0.00058956, -0.00397890}});
