...
bool isClose(const mipp::vector<Real> &expected, const mipp::vector<Real> &found, const double &tol) {
    return std::equal(expected.begin(), expected.end(), found.begin(),
                      [&tol](const Real &a, const Real &b) -> bool { return (std::abs(a - b) < tol); });
}

template <typename Real>
bool isClose(const mipp::vector<std::complex<Real>> &expected, const mipp::vector<std::complex<Real>> &found,
             const double &tol) {
...
TEST_CASE("test the fftw wrapper class.") {
    ...
    SECTION("double precision tests") {
        ...
        mipp::vector<double> input{0.1, 0.3, 0.6, 0.9};
        mipp::vector<double> refFromComplex{0.4, 1.2, 2.4, 3.6};
        mipp::vector<std::complex<double>> refComplex1 = {
            std::complex<double>(1.9, 0.0), std::complex<double>(-0.5, 0.6), std::complex<double>(-0.5, 0.0)};
        mipp::vector<std::complex<double>> complexIn = {std::complex<double>(1.0, 0.0), std::complex<double>(2.0, -1.0),
                                                        std::complex<double>(0.0, -1.0),
                                                        std::complex<double>(-1.0, 2.0)};
        mipp::vector<std::complex<double>> refComplexIn = {
            std::complex<double>(4.0, 0.0), std::complex<double>(8.0, -4.0), std::complex<double>(0.0, -4.0),
            std::complex<double>(-4.0, 8.0)};
        mipp::vector<std::complex<double>> refComplexToComplex = {
            std::complex<double>(2.0, 0.0), std::complex<double>(-2.0, -2.0), std::complex<double>(0.0, -2.0),
            std::complex<double>(4.0, 4.0)};
        mipp::vector<std::complex<double>> realToComplex(3);
        mipp::vector<double> realFromComplex(4);
    ...
    SECTION("long double precision tests") {
        ...
        mipp::vector<long double> input{0.1, 0.3, 0.6, 0.9};
        mipp::vector<long double> refFromComplex{0.4, 1.2, 2.4, 3.6};
        mipp::vector<std::complex<long double>> refComplex1 = {std::complex<long double>(1.9, 0.0),
                                                               std::complex<long double>(-0.5, 0.6),
                                                               std::complex<long double>(-0.5, 0.0)};
        mipp::vector<std::complex<long double>> complexIn = {
        ...
        mipp::vector<std::complex<long double>> refComplexIn = {
        ...
        mipp::vector<std::complex<long double>> refComplexToComplex = {
        ...
        mipp::vector<std::complex<long double>> realToComplex(3);
        mipp::vector<long double> realFromComplex(4);
