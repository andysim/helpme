...
if(TARGET fftw::fftwd)
    set_property(TARGET fftw::fftw PROPERTY INTERFACE_LINK_LIBRARIES fftw::fftwd)
    set(FFTW_LIBRARIES ${FFTW_LIBRARIES} $<TARGET_PROPERTY:fftw::fftwd,INTERFACE_LINK_LIBRARIES>)
endif()
if(TARGET fftw::fftwf)
    set_property(TARGET fftw::fftw PROPERTY INTERFACE_LINK_LIBRARIES fftw::fftwf)
    set(FFTW_LIBRARIES ${FFTW_LIBRARIES} $<TARGET_PROPERTY:fftw::fftwf,INTERFACE_LINK_LIBRARIES>)
endif()
if(TARGET fftw::fftwl)
    set_property(TARGET fftw::fftw PROPERTY INTERFACE_LINK_LIBRARIES fftw::fftwl)
