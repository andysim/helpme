...
# Make sure the compiler tests also pass flags to the linker
...
set(CMAKE_REQUIRED_QUIET_SAVE ${CMAKE_REQUIRED_QUIET})
   ...
   foreach(flag_i IN LISTS flags_to_try ITEMS -brillig)
      ...
      set(OLDLINKFLAGS "${CMAKE_EXE_LINKER_FLAGS}")
      set(CMAKE_EXE_LINKER_FLAGS "${flag_i} ${CMAKE_EXE_LINKER_FLAGS}")
      if(${is_C} EQUAL 0)
      ...
      if(${test_option})
        ...
        set(CMAKE_EXE_LINKER_FLAGS "${OLDLINKFLAGS}")
        if(NOT CMAKE_REQUIRED_QUIET_SAVE)
